...
namespace EyeCT4Events
{
    public partial class CreateParticipantForm : Form
    {
        ...
        {
            person = new Person(tbCreateParticipantName.Text, dtpCreateParticipantDateOfBirth.Value, tbCreateParticipantCity.Text + " " + tbCreateParticipantZipCode.Text,tbCreateParticipantPhoneNumber.Text, tbCreateParticipantRekeningnummer.Text, tbCreateParticipantEmail.Text,tbCreateParticipantPassword.Text);
